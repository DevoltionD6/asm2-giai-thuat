...
public class OperationtoProduce {
    ...
    // selection sort
    private static void seletionSortByCode(MyList<Product> list, Node<Product> i) {
        if (i == list.tail) {
            return;
        }
    ...
    private void addFirst(MyList<Product> list, Scanner sc) {
        Product newProduct = createProduct(sc);
